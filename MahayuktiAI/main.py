#!/usr/bin/env python3
"""
Mahayukti AI — YouTube Automation
...
from video_composer import compose_short, compose_long
...
def run_short() -> None:
    ...
    generate_audio(script["script"], audio_path, srt_path, voice=SHORT_VOICE)
...
def run_long() -> None:
    ...
    print("  Generating audio...")
    generate_audio(script["full_script"], audio_path, srt_path, voice=LONG_VOICE)
